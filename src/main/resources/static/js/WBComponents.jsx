...
const palabras=paisses();
   ...
   var pais = palabras[Math.floor(Math.random()*palabras.length)];
   console.log(pais);
   console.log(rand2);
   console.log(rand3);
const word=Array.from(paisses()[rand1]);
const word2=Array.from(paisses()[rand2]);
const word3=Array.from(paisses()[rand3]);
